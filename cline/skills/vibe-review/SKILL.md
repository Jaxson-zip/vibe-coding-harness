---
name: vibe-review
description: Review code against 6-category checklist (contract/coverage/boundary/security/scope-creep/style). Read-only, produces REVIEW.md with P0/P1/P2 issues and triggers Human Checkpoint on P0. MUST use a different AI tool than the implementer (cross-tool review). Triggers on: "code review", "review code", "审查", "code review checklist", "/vibe-review".
---
...
- 当前 feature 已有实现代码
- **强烈建议**:本命令用与实现者不同的 AI 工具执行(交叉审查)。实现工具 → 审查工具映射:
...
### Step 4: 出 REVIEW 报告
写到 `docs/REVIEW-{today}-{NN}-{描述}.md`,结构按 reviewer 角色定义的产物契约。
