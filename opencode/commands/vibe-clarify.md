---
description: List ambiguities and open questions before writing any code. Must run after /vibe-spec.
agent: general
---
...
## 铁律
- **不动手写代码**,只问问题和记答案。
- 如果 spec 已经足够清晰没有歧义(罕见),也要明确说"我扫了一遍,没有歧义点,可以进入 /vibe-plan"。
