---
description: Resume work after passive interruption (quota exhausted / network down / crash / tab closed). Reconstructs state from docs/ and git diff, no handoff package needed.
agent: general
---
...
6. `templates/roles/<CURRENT 里的角色>.md` — 角色定义
