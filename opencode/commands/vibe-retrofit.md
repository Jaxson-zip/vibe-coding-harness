---
description: Retrofitting an existing project with Vibe Coding engineering harness — scan codebase, diagnose issues, generate AGENTS.md and docs/, define refactoring boundaries.
agent: general
---
...
- **Part 1 (Behavior Rules)**: Use standard template from vibe-coding skill, keeping existing conventions (e.g., if the project uses 4-space indentation, don't write 2-space)
